(function() {
    ...
    var FeedView = Backbone.View.extend({
                        ...
                        require(['../checkins/backbone-checkins.js'], function(CheckinsBackbone){
                            ...
                            require(['../urls/backbone-urls.js'], function(UrlsBackbone){
                                ...
                                require(['../posts/backbone-posts.js'], function(PostsBackbone){
                                    ...
                                    require(['backbone-feed.js'], function(ModelBackbone){
                                        self.FeedBackbone = ModelBackbone;
                                        self.$feedList = $('<div class="feed-list"></div>');
                                        self.$feedViewer = $('<div class="feed-item-viewer"><a class="carousel-control left" href="#home" data-slide="prev">‹</a><a class="carousel-control right" href="#home" data-slide="next">›</a></div>');
        ...
        render: function() {
            ...
            this.$el.append(this.$feedViewer);
            return this;
        },
        events: {
