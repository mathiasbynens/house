...
window.rangy=function(){function a(a,b){var c=typeof a[b];return c==k||!(c!=h||!a[b])||"unknown"==c}function c(a,b){return!(typeof a[b]!=h||!a[b])}function b(a,b){return typeof a[b]!=p}function d(a){return function(b,c){for(var d=c.length;d--;)if(!a(b,c[d]))return!1;return!0}}function e(a){return a&&r(a,q)&&w(a,D)}function f(a){window.alert("Rangy not supported in your browser. Reason: "+a);t.initialized=!0;t.supported=!1}function g(){if(!t.initialized){var b,d=!1,k=!1;a(document,"createRange")&&
(b=document.createRange(),r(b,u)&&w(b,m)&&(d=!0),b.detach());(b=c(document,"body")?document.body:document.getElementsByTagName("body")[0])&&a(b,"createTextRange")&&(b=b.createTextRange(),e(b)&&(k=!0));d||k||f("Neither Range nor TextRange are implemented");t.initialized=!0;t.features={implementsDomRange:d,implementsTextRange:k};d=A.concat(B);k=0;for(b=d.length;k<b;++k)try{d[k](t)}catch(h){c(window,"console")&&a(window.console,"log")&&window.console.log("Init listener threw an exception. Continuing.",
h)}}}function l(a){this.name=a;this.supported=this.initialized=!1}var h="object",k="function",p="undefined",m="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer START_TO_START START_TO_END END_TO_START END_TO_END".split(" "),u="setStart setStartBefore setStartAfter setEnd setEndBefore setEndAfter collapse selectNode selectNodeContents compareBoundaryPoints deleteContents extractContents cloneContents insertNode surroundContents cloneRange toString detach".split(" "),
D="boundingHeight boundingLeft boundingTop boundingWidth htmlText text".split(" "),q="collapse compareEndPoints duplicate getBookmark moveToBookmark moveToElementText parentElement pasteHTML select setEndPoint getBoundingClientRect".split(" "),r=d(a),s=d(c),w=d(b),t={version:"1.2.2",initialized:!1,supported:!0,util:{isHostMethod:a,isHostObject:c,isHostProperty:b,areHostMethods:r,areHostObjects:s,areHostProperties:w,isTextRange:e},features:{},modules:{},config:{alertOnWarn:!1,preferTextRange:!1}};
t.fail=f;t.warn=function(a){a="Rangy warning: "+a;t.config.alertOnWarn?window.alert(a):typeof window.console!=p&&typeof window.console.log!=p&&window.console.log(a)};({}).hasOwnProperty?t.util.extend=function(a,b){for(var c in b)b.hasOwnProperty(c)&&(a[c]=b[c])}:f("hasOwnProperty not supported");var B=[],A=[];t.init=g;t.addInitListener=function(a){t.initialized?a(t):B.push(a)};var v=[];t.addCreateMissingNativeApiListener=function(a){v.push(a)};t.createMissingNativeApi=function(a){a=a||window;g();
for(var b=0,c=v.length;b<c;++b)v[b](a)};l.prototype.fail=function(a){this.initialized=!0;this.supported=!1;throw Error("Module '"+this.name+"' failed to load: "+a);};l.prototype.warn=function(a){t.warn("Module "+this.name+": "+a)};l.prototype.createError=function(a){return Error("Error in Rangy "+this.name+" module: "+a)};t.createModule=function(a,b){var c=new l(a);t.modules[a]=c;A.push(function(a){b(a,c);c.initialized=!0;c.supported=!0})};t.requireModules=function(a){for(var b=0,c=a.length,d,e;b<
c;++b){e=a[b];d=t.modules[e];if(!(d&&d instanceof l))throw Error("Module '"+e+"' not found");if(!d.supported)throw Error("Module '"+e+"' not supported");}};var E=!1,s=function(a){E||(E=!0,t.initialized||g())};if(typeof window==p)f("No window found");else if(typeof document==p)f("No document found");else return a(document,"addEventListener")&&document.addEventListener("DOMContentLoaded",s,!1),a(window,"addEventListener")?window.addEventListener("load",s,!1):a(window,"attachEvent")?window.attachEvent("onload",
...
for(c=c.firstChild;c;){if(c===a)return-1;if(c===k)return 1;c=c.nextSibling}throw Error("Should not be here!");},inspectNode:h,fragmentFromNodeChildren:function(a){for(var b=l(a).createDocumentFragment(),c;c=a.firstChild;)b.appendChild(c);return b},createIterator:function(a){return new k(a)},DomPosition:p};a.DOMException=m});
...
this.codeName=a;this.message="RangeException: "+this.codeName}function s(a,b,c){this.nodes=u(a,b,c);this._next=this.nodes[0];this._position=0}function w(a){return function(b,c){for(var d,k=c?b:b.parentNode;k;){d=k.nodeType;if(n.arrayContains(a,d))return k;k=k.parentNode}return null}}function t(a,b){if(da(a,b))throw new r("INVALID_NODE_TYPE_ERR");}function B(a){if(!a.startContainer)throw new G("INVALID_STATE_ERR");}function A(a,b){if(!n.arrayContains(b,a.nodeType))throw new r("INVALID_NODE_TYPE_ERR");
}function v(a,b){if(0>b||b>(n.isCharacterDataNode(a)?a.length:a.childNodes.length))throw new G("INDEX_SIZE_ERR");}function E(a,b){if(S(a,!0)!==S(b,!0))throw new G("WRONG_DOCUMENT_ERR");}function y(a){if(ea(a,!0))throw new G("NO_MODIFICATION_ALLOWED_ERR");}function z(a,b){if(!a)throw new G(b);}function J(a){return!n.arrayContains(X,a.nodeType)&&!S(a,!0)}function O(a,b){return b<=(n.isCharacterDataNode(a)?a.length:a.childNodes.length)}function C(a){B(a);if(J(a.startContainer)||J(a.endContainer)||!O(a.startContainer,
a.startOffset)||!O(a.endContainer,a.endOffset))throw Error("Range error: Range is no longer valid after DOM mutation ("+a.inspect()+")");}function I(){}function M(a){a.START_TO_START=T;a.START_TO_END=Y;a.END_TO_END=fa;a.END_TO_START=Z;a.NODE_BEFORE=$;a.NODE_AFTER=aa;a.NODE_BEFORE_AND_AFTER=ba;a.NODE_INSIDE=U}function P(a){M(a);M(a.prototype)}function N(a,b){return function(){C(this);var c=this.startContainer,d=this.startOffset,e=this.commonAncestorContainer,h=new q(this,!0);c!==e&&(c=n.getClosestAncestorIn(c,
e,!0),d=g(c),c=d.node,d=d.offset);k(h,y);h.reset();e=a(h);h.detach();b(this,c,d,c,d);return e}}function Q(c,d,k){function e(a,b){return function(c){B(this);A(c,K);A(R(c),X);c=(a?f:g)(c);(b?h:l)(this,c.node,c.offset)}}function h(a,b,c){var k=a.endContainer,e=a.endOffset;if(b!==a.startContainer||c!==a.startOffset){if(R(b)!=R(k)||1==n.comparePoints(b,c,k,e))k=b,e=c;d(a,b,c,k,e)}}function l(a,b,c){var k=a.startContainer,e=a.startOffset;if(b!==a.endContainer||c!==a.endOffset){if(R(b)!=R(k)||-1==n.comparePoints(b,
c,k,e))k=b,e=c;d(a,k,e,b,c)}}c.prototype=new I;a.util.extend(c.prototype,{setStart:function(a,b){B(this);t(a,!0);v(a,b);h(this,a,b)},setEnd:function(a,b){B(this);t(a,!0);v(a,b);l(this,a,b)},setStartBefore:e(!0,!0),setStartAfter:e(!1,!0),setEndBefore:e(!0,!1),setEndAfter:e(!1,!1),collapse:function(a){C(this);a?d(this,this.startContainer,this.startOffset,this.startContainer,this.startOffset):d(this,this.endContainer,this.endOffset,this.endContainer,this.endOffset)},selectNodeContents:function(a){B(this);
t(a,!0);d(this,a,0,a,n.getNodeLength(a))},selectNode:function(a){B(this);t(a,!1);A(a,K);var b=f(a);a=g(a);d(this,b.node,b.offset,a.node,a.offset)},extractContents:N(m,d),deleteContents:N(p,d),canSurroundContents:function(){C(this);y(this.startContainer);y(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},detach:function(){k(this)},splitBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=
this.endOffset,e=a===c;n.isCharacterDataNode(c)&&0<k&&k<c.length&&n.splitDataNode(c,k);n.isCharacterDataNode(a)&&0<b&&b<a.length&&(a=n.splitDataNode(a,b),e?(k-=b,c=a):c==a.parentNode&&k>=n.getNodeIndex(a)&&k++,b=0);d(this,a,b,c,k)},normalizeBoundaries:function(){C(this);var a=this.startContainer,b=this.startOffset,c=this.endContainer,k=this.endOffset,e=function(a){var b=a.nextSibling;b&&b.nodeType==a.nodeType&&(c=a,k=a.length,a.appendData(b.data),b.parentNode.removeChild(b))},h=function(d){var e=
d.previousSibling;if(e&&e.nodeType==d.nodeType){a=d;var h=d.length;b=e.length;d.insertData(0,e.data);e.parentNode.removeChild(e);a==c?(k+=b,c=a):c==d.parentNode&&(e=n.getNodeIndex(d),k==e?(c=d,k=h):k>e&&k--)}},f=!0;n.isCharacterDataNode(c)?c.length==k&&e(c):(0<k&&(f=c.childNodes[k-1])&&n.isCharacterDataNode(f)&&e(f),f=!this.collapsed);f?n.isCharacterDataNode(a)?0==b&&h(a):b<a.childNodes.length&&(e=a.childNodes[b])&&n.isCharacterDataNode(e)&&h(e):(a=c,b=k);d(this,a,b,c,k)},collapseToPoint:function(a,
b){B(this);t(a,!0);v(a,b);a===this.startContainer&&b===this.startOffset&&a===this.endContainer&&b===this.endOffset||d(this,a,b,a,b)}});P(c)}function H(a){a.collapsed=a.startContainer===a.endContainer&&a.startOffset===a.endOffset;a.commonAncestorContainer=a.collapsed?a.startContainer:n.getCommonAncestor(a.startContainer,a.endContainer)}function x(a,b,c,d,k){var h=a.startContainer!==b||a.startOffset!==c,f=a.endContainer!==d||a.endOffset!==k;a.startContainer=b;a.startOffset=c;a.endContainer=d;a.endOffset=
k;H(a);e(a,"boundarychange",{startMoved:h,endMoved:f})}function F(a){this.startContainer=a;this.startOffset=0;this.endContainer=a;this.endOffset=0;this._listeners={boundarychange:[],detach:[]};H(this)}a.requireModules(["DomUtil"]);var n=a.dom,L=n.DomPosition,G=a.DOMException;q.prototype={_current:null,_next:null,_first:null,_last:null,isSingleCharacterDataNode:!1,reset:function(){this._current=null;this._next=this._first},hasNext:function(){return!!this._next},next:function(){var a=this._current=
...
this.range)},getSubtreeIterator:function(){var a;if(this.isSingleCharacterDataNode)a=this.range.cloneRange(),a.collapse();else{a=new F(d(this.range));var b=this._current,c=b,k=0,e=b,h=n.getNodeLength(b);n.isAncestorOf(b,this.sc,!0)&&(c=this.sc,k=this.so);n.isAncestorOf(b,this.ec,!0)&&(e=this.ec,h=this.eo);x(a,c,k,e,h)}return new q(a,this.clonePartiallySelectedTextNodes)},detach:function(a){a&&this.range.detach();this.range=this._current=this._next=this._first=this._last=this.sc=this.so=this.ec=this.eo=
null}};r.prototype={BAD_BOUNDARYPOINTS_ERR:1,INVALID_NODE_TYPE_ERR:2};r.prototype.toString=function(){return this.message};s.prototype={_current:null,hasNext:function(){return!!this._next},next:function(){this._current=this._next;this._next=this.nodes[++this._position];return this._current},detach:function(){this._current=this._next=this.nodes=null}};var K=[1,3,4,5,7,8,10],X=[2,9,11],ga=[1,3,4,5,7,8,10,11],ha=[1,3,4,5,7,8],R=n.getRootContainer,S=w([9,11]),ea=w([5,6,10,12]),da=w([6,10,12]),ca=document.createElement("style"),
V=!1;try{ca.innerHTML="<b>x</b>",V=3==ca.firstChild.nodeType}catch(ia){}a.features.htmlParsingConforms=V;var W="startContainer startOffset endContainer endOffset collapsed commonAncestorContainer".split(" "),T=0,Y=1,fa=2,Z=3,$=0,aa=1,ba=2,U=3;I.prototype={attachListener:function(a,b){this._listeners[a].push(b)},compareBoundaryPoints:function(a,b){C(this);E(this.startContainer,b.startContainer);var c=a==Z||a==T?"start":"end",d=a==Y||a==T?"start":"end";return n.comparePoints(this[c+"Container"],this[c+
"Offset"],b[d+"Container"],b[d+"Offset"])},insertNode:function(a){C(this);A(a,ga);y(this.startContainer);if(n.isAncestorOf(a,this.startContainer,!0))throw new G("HIERARCHY_REQUEST_ERR");a=l(a,this.startContainer,this.startOffset);this.setStartBefore(a)},cloneContents:function(){C(this);var a,b;if(this.collapsed)return d(this).createDocumentFragment();if(this.startContainer===this.endContainer&&n.isCharacterDataNode(this.startContainer))return a=this.startContainer.cloneNode(!0),a.data=a.data.slice(this.startOffset,
this.endOffset),b=d(this).createDocumentFragment(),b.appendChild(a),b;b=new q(this,!0);a=h(b);b.detach();return a},canSurroundContents:function(){C(this);y(this.startContainer);y(this.endContainer);var a=new q(this,!0),c=a._first&&b(a._first,this)||a._last&&b(a._last,this);a.detach();return!c},surroundContents:function(a){A(a,ha);if(!this.canSurroundContents())throw new r("BAD_BOUNDARYPOINTS_ERR");var b=this.extractContents();if(a.hasChildNodes())for(;a.lastChild;)a.removeChild(a.lastChild);l(a,this.startContainer,
this.startOffset);a.appendChild(b);this.selectNode(a)},cloneRange:function(){C(this);for(var a=new F(d(this)),b=W.length,c;b--;)c=W[b],a[c]=this[c];return a},toString:function(){C(this);var a=this.startContainer;if(a===this.endContainer&&n.isCharacterDataNode(a))return 3==a.nodeType||4==a.nodeType?a.data.slice(this.startOffset,this.endOffset):"";var b=[],a=new q(this,!0);k(a,function(a){3!=a.nodeType&&4!=a.nodeType||b.push(a.data)});a.detach();return b.join("")},compareNode:function(a){C(this);var b=
a.parentNode,c=n.getNodeIndex(a);if(!b)throw new G("NOT_FOUND_ERR");a=this.comparePoint(b,c);b=this.comparePoint(b,c+1);return 0>a?0<b?ba:$:0<b?aa:U},comparePoint:function(a,b){C(this);z(a,"HIERARCHY_REQUEST_ERR");E(a,this.startContainer);return 0>n.comparePoints(a,b,this.startContainer,this.startOffset)?-1:0<n.comparePoints(a,b,this.endContainer,this.endOffset)?1:0},createContextualFragment:V?function(a){var b=this.startContainer,c=n.getDocument(b);if(!b)throw new G("INVALID_STATE_ERR");var d=null;
1==b.nodeType?d=b:n.isCharacterDataNode(b)&&(d=n.parentElement(b));d=null===d||"HTML"==d.nodeName&&n.isHtmlNamespace(n.getDocument(d).documentElement)&&n.isHtmlNamespace(d)?c.createElement("body"):d.cloneNode(!1);d.innerHTML=a;return n.fragmentFromNodeChildren(d)}:function(a){B(this);var b=d(this).createElement("body");b.innerHTML=a;return n.fragmentFromNodeChildren(b)},toHtml:function(){C(this);var a=d(this).createElement("div");a.appendChild(this.cloneContents());return a.innerHTML},intersectsNode:function(a,
b){C(this);z(a,"NOT_FOUND_ERR");if(n.getDocument(a)!==d(this))return!1;var c=a.parentNode,k=n.getNodeIndex(a);z(c,"NOT_FOUND_ERR");var e=n.comparePoints(c,k,this.endContainer,this.endOffset),c=n.comparePoints(c,k+1,this.startContainer,this.startOffset);return b?0>=e&&0<=c:0>e&&0<c},isPointInRange:function(a,b){C(this);z(a,"HIERARCHY_REQUEST_ERR");E(a,this.startContainer);return 0<=n.comparePoints(a,b,this.startContainer,this.startOffset)&&0>=n.comparePoints(a,b,this.endContainer,this.endOffset)},
intersectsRange:function(a,b){C(this);if(d(a)!=d(this))throw new G("WRONG_DOCUMENT_ERR");var c=n.comparePoints(this.startContainer,this.startOffset,a.endContainer,a.endOffset),k=n.comparePoints(this.endContainer,this.endOffset,a.startContainer,a.startOffset);return b?0>=c&&0<=k:0>c&&0<k},intersection:function(a){if(this.intersectsRange(a)){var b=n.comparePoints(this.startContainer,this.startOffset,a.startContainer,a.startOffset),c=n.comparePoints(this.endContainer,this.endOffset,a.endContainer,a.endOffset),
d=this.cloneRange();-1==b&&d.setStart(a.startContainer,a.startOffset);1==c&&d.setEnd(a.endContainer,a.endOffset);return d}return null},union:function(a){if(this.intersectsRange(a,!0)){var b=this.cloneRange();-1==n.comparePoints(a.startContainer,a.startOffset,this.startContainer,this.startOffset)&&b.setStart(a.startContainer,a.startOffset);1==n.comparePoints(a.endContainer,a.endOffset,this.endContainer,this.endOffset)&&b.setEnd(a.endContainer,a.endOffset);return b}throw new r("Ranges do not intersect");
...
b){C(this);return new s(this,a,b)},getNodes:function(a,b){C(this);return u(this,a,b)},getDocument:function(){return d(this)},collapseBefore:function(a){B(this);this.setEndBefore(a);this.collapse(!1)},collapseAfter:function(a){B(this);this.setStartAfter(a);this.collapse(!0)},getName:function(){return"DomRange"},equals:function(a){return F.rangesEqual(this,a)},inspect:function(){return D(this)}};Q(F,x,function(a){B(a);a.startContainer=a.startOffset=a.endContainer=a.endOffset=null;a.collapsed=a.commonAncestorContainer=
null;e(a,"detach",null);a._listeners=null});a.rangePrototype=I.prototype;F.rangeProperties=W;F.RangeIterator=q;F.copyComparisonConstants=P;F.createPrototypeRange=Q;F.inspect=D;F.getRangeDocument=d;F.rangesEqual=function(a,b){return a.startContainer===b.startContainer&&a.startOffset===b.startOffset&&a.endContainer===b.endContainer&&a.endOffset===b.endOffset};a.DomRange=F;a.RangeException=r});
...
b=b=null})});
rangy.createModule("WrappedSelection",function(a,c){function b(a){return(a||window).getSelection()}function d(a){return(a||window).document.selection}function e(a,b,c){var d=c?"end":"start";c=c?"start":"end";a.anchorNode=b[d+"Container"];a.anchorOffset=b[d+"Offset"];a.focusNode=b[c+"Container"];a.focusOffset=b[c+"Offset"]}function f(a){a.anchorNode=a.focusNode=null;a.anchorOffset=a.focusOffset=0;a.rangeCount=0;a.isCollapsed=!0;a._ranges.length=0}function g(b){var c;b instanceof w?(c=b._selectionNativeRange,
...
b._ranges.push(d);b.isCollapsed=1==b.rangeCount&&b._ranges[0].collapsed;e(b,b._ranges[b.rangeCount-1],!1)}}}function p(a,b){for(var c=a.docSelection.createRange(),d=l(b),e=r.getDocument(c.item(0)),e=r.getBody(e).createControlRange(),h=0,f=c.length;h<f;++h)e.add(c.item(h));try{e.add(d)}catch(g){throw Error("addRange(): Element within the specified Range could not be added to control selection (does it have layout?)");}e.select();k(a)}function m(a,b,c){this.nativeSelection=a;this.docSelection=b;this._ranges=
[];this.win=c;this.refresh()}function u(a,b){for(var c=r.getDocument(b[0].startContainer),c=r.getBody(c).createControlRange(),d=0,e;d<rangeCount;++d){e=l(b[d]);try{c.add(e)}catch(h){throw Error("setRanges(): Element within the one of the specified Ranges could not be added to control selection (does it have layout?)");}}c.select();k(a)}function D(a,b){if(a.anchorNode&&r.getDocument(a.anchorNode)!==r.getDocument(b))throw new B("WRONG_DOCUMENT_ERR");}function q(a){var b=[],c=new A(a.anchorNode,a.anchorOffset),
d=new A(a.focusNode,a.focusOffset),e="function"==typeof a.getName?a.getName():"Selection";if("undefined"!=typeof a.rangeCount)for(var h=0,k=a.rangeCount;h<k;++h)b[h]=w.inspect(a.getRangeAt(h));return"["+e+"(Ranges: "+b.join(", ")+")(anchor: "+c.inspect()+", focus: "+d.inspect()+"]"}a.requireModules(["DomUtil","DomRange","WrappedRange"]);a.config.checkSelectionRanges=!0;var r=a.dom,s=a.util,w=a.DomRange,t=a.WrappedRange,B=a.DOMException,A=r.DomPosition,v,E,y=a.util.isHostMethod(window,"getSelection"),
z=a.util.isHostObject(document,"selection"),J=z&&(!y||a.config.preferTextRange);J?(v=d,a.isSelectionValid=function(a){a=(a||window).document;var b=a.selection;return"None"!=b.type||r.getDocument(b.createRange().parentElement())==a}):y?(v=b,a.isSelectionValid=function(){return!0}):c.fail("Neither document.selection or window.getSelection() detected.");a.getNativeSelection=v;var y=v(),O=a.createNativeRange(document),C=r.getBody(document),I=s.areHostObjects(y,s.areHostProperties(y,["anchorOffset","focusOffset"]));
a.features.selectionHasAnchorAndFocus=I;var M=s.isHostMethod(y,"extend");a.features.selectionHasExtend=M;var P="number"==typeof y.rangeCount;a.features.selectionHasRangeCount=P;var N=!1,Q=!0;s.areHostMethods(y,["addRange","getRangeAt","removeAllRanges"])&&"number"==typeof y.rangeCount&&a.features.implementsDomRange&&function(){var a=document.createElement("iframe");C.appendChild(a);var b=r.getIframeDocument(a);b.open();b.write("<html><head></head><body>12</body></html>");b.close();var c=r.getIframeWindow(a).getSelection(),
d=b.documentElement.lastChild.firstChild,b=b.createRange();b.setStart(d,1);b.collapse(!0);c.addRange(b);Q=1==c.rangeCount;c.removeAllRanges();var e=b.cloneRange();b.setStart(d,0);e.setEnd(d,2);c.addRange(b);c.addRange(e);N=2==c.rangeCount;b.detach();e.detach();C.removeChild(a)}();a.features.selectionSupportsMultipleRanges=N;a.features.collapsedNonEditableSelectionsSupported=Q;var H=!1,x;C&&s.isHostMethod(C,"createControlRange")&&(x=C.createControlRange(),s.areHostProperties(x,["item","add"])&&(H=
!0));a.features.implementsControlRange=H;E=I?function(a){return a.anchorNode===a.focusNode&&a.anchorOffset===a.focusOffset}:function(a){return a.rangeCount?a.getRangeAt(a.rangeCount-1).collapsed:!1};var F;s.isHostMethod(y,"getRangeAt")?F=function(a,b){try{return a.getRangeAt(b)}catch(c){return null}}:I&&(F=function(b){var c=r.getDocument(b.anchorNode),c=a.createRange(c);c.setStart(b.anchorNode,b.anchorOffset);c.setEnd(b.focusNode,b.focusOffset);c.collapsed!==this.isCollapsed&&(c.setStart(b.focusNode,
b.focusOffset),c.setEnd(b.anchorNode,b.anchorOffset));return c});a.getSelection=function(a){a=a||window;var b=a._rangySelection,c=v(a),e=z?d(a):null;b?(b.nativeSelection=c,b.docSelection=e,b.refresh(a)):(b=new m(c,e,a),a._rangySelection=b);return b};a.getIframeSelection=function(b){return a.getSelection(r.getIframeWindow(b))};x=m.prototype;if(!J&&I&&s.areHostMethods(y,["removeAllRanges","addRange"])){x.removeAllRanges=function(){this.nativeSelection.removeAllRanges();f(this)};var n=function(b,c){var d=
w.getRangeDocument(c),d=a.createRange(d);d.collapseToPoint(c.endContainer,c.endOffset);b.nativeSelection.addRange(g(d));b.nativeSelection.extend(c.startContainer,c.startOffset);b.refresh()};x.addRange=P?function(b,c){if(H&&z&&"Control"==this.docSelection.type)p(this,b);else if(c&&M)n(this,b);else{var d;N?d=this.rangeCount:(this.removeAllRanges(),d=0);this.nativeSelection.addRange(g(b));this.rangeCount=this.nativeSelection.rangeCount;this.rangeCount==d+1?(a.config.checkSelectionRanges&&(d=F(this.nativeSelection,
this.rangeCount-1))&&!w.rangesEqual(d,b)&&(b=new t(d)),this._ranges[this.rangeCount-1]=b,e(this,b,K(this.nativeSelection)),this.isCollapsed=E(this)):this.refresh()}}:function(a,b){b&&M?n(this,a):(this.nativeSelection.addRange(g(a)),this.refresh())};x.setRanges=function(a){if(H&&1<a.length)u(this,a);else{this.removeAllRanges();for(var b=0,c=a.length;b<c;++b)this.addRange(a[b])}}}else if(s.isHostMethod(y,"empty")&&s.isHostMethod(O,"select")&&H&&J)x.removeAllRanges=function(){try{if(this.docSelection.empty(),
"None"!=this.docSelection.type){var a;if(this.anchorNode)a=r.getDocument(this.anchorNode);else if("Control"==this.docSelection.type){var b=this.docSelection.createRange();b.length&&(a=r.getDocument(b.item(0)).body.createTextRange())}a&&(a.body.createTextRange().select(),this.docSelection.empty())}}catch(c){}f(this)},x.addRange=function(a){"Control"==this.docSelection.type?p(this,a):(t.rangeToTextRange(a).select(),this._ranges[0]=a,this.rangeCount=1,this.isCollapsed=this._ranges[0].collapsed,e(this,
a,!1))},x.setRanges=function(a){this.removeAllRanges();var b=a.length;1<b?u(this,a):b&&this.addRange(a[0])};else return c.fail("No means of selecting a Range or TextRange was found"),!1;x.getRangeAt=function(a){if(0>a||a>=this.rangeCount)throw new B("INDEX_SIZE_ERR");return this._ranges[a]};var L;if(J)L=function(b){var c;a.isSelectionValid(b.win)?c=b.docSelection.createRange():(c=r.getBody(b.win.document).createTextRange(),c.collapse(!0));"Control"==b.docSelection.type?k(b):c&&"undefined"!=typeof c.text?
h(b,c):f(b)};else if(s.isHostMethod(y,"getRangeAt")&&"number"==typeof y.rangeCount)L=function(b){if(H&&z&&"Control"==b.docSelection.type)k(b);else if(b._ranges.length=b.rangeCount=b.nativeSelection.rangeCount,b.rangeCount){for(var c=0,d=b.rangeCount;c<d;++c)b._ranges[c]=new a.WrappedRange(b.nativeSelection.getRangeAt(c));e(b,b._ranges[b.rangeCount-1],K(b.nativeSelection));b.isCollapsed=E(b)}else f(b)};else if(I&&"boolean"==typeof y.isCollapsed&&"boolean"==typeof O.collapsed&&a.features.implementsDomRange)L=
...
wysihtml5.dom.getStyle=function(){function a(a){return a.replace(b,function(a){return a.charAt(1).toUpperCase()})}var c={"float":"styleFloat"in document.createElement("div").style?"styleFloat":"cssFloat"},b=/\-[a-z]/g;return function(b){return{from:function(e){if(e.nodeType===wysihtml5.ELEMENT_NODE){var f=e.ownerDocument,g=c[b]||a(b),l=e.style,h=e.currentStyle,k=l[g];if(k)return k;if(h)try{return h[g]}catch(p){}var g=f.defaultView||f.parentWindow,f=("height"===b||"width"===b)&&"TEXTAREA"===e.nodeName,
...
(h="div"));if(h in f){b=f[h];if(!b||b.remove)return null;b="string"===typeof b?{rename_tag:b}:b}else if(a.firstChild)b={rename_tag:d};else return null;h=a.ownerDocument.createElement(b.rename_tag||h);var f={},l=b.set_class,s=b.add_class,w=b.set_attributes,t=b.check_attributes,B=b.allow_attributes,A=g.classes,v=0,E=[];b=[];var y=[],v=[],z;w&&(f=wysihtml5.lang.object(w).clone());if(B)for(allowAttributesLength=B.length,v=0;v<allowAttributesLength;v++)z=B[v],w=c(a,z),"string"===typeof w&&(f[z]=w);if(t)for(z in t){w=
null;v=t[z];switch(typeof v){case "string":(v=k[v])&&(w=v(c(a,z)));break;case "boolean":v&&(w=c(a,z));break;case "function":w=v(c(a,z))}"string"===typeof w&&(f[z]=w)}l&&E.push(l);if(s)for(z in s)if(v=p[s[z]])l=v(c(a,z)),"string"===typeof l&&E.push(l);A["_wysihtml5-temp-placeholder"]=1;(v=a.getAttribute("class"))&&(E=E.concat(v.split(e)));s=E.length;for(v=0;v<s;v++)a=E[v],(A[a]||A["*"])&&b.push(a);for(A=b.length;A--;)a=b[A],wysihtml5.lang.array(y).contains(a)||y.unshift(a);y.length&&(f["class"]=y.join(" "));
for(z in f)try{h.setAttribute(z,f[z])}catch(J){}f.src&&("undefined"!==typeof f.width&&h.setAttribute("width",f.width),"undefined"!==typeof f.height&&h.setAttribute("height",f.height));return h},3:function(a){var b=a.nextSibling;if(b&&b.nodeType===wysihtml5.TEXT_NODE)b.data=a.data+b.data;else return b=a.data.replace(h,""),a.ownerDocument.createTextNode(b)}},d="span",e=/\s+/,f={tags:{},classes:{}},g={},l=!wysihtml5.browser.supportsGetAttributeCorrectly(),h=/\uFEFF/g,k={url:function(){var a=/^(https?:)?\/\//i;
...
/\D/g;return function(b){return(b=(b||"").replace(a,""))||null}}()},p={align_img:function(){var a={left:"wysiwyg-float-left",right:"wysiwyg-float-right"};return function(b){return a[String(b).toLowerCase()]}}(),align_text:function(){var a={left:"wysiwyg-text-align-left",right:"wysiwyg-text-align-right",center:"wysiwyg-text-align-center",justify:"wysiwyg-text-align-justify"};return function(b){return a[String(b).toLowerCase()]}}(),clear_br:function(){var a={left:"wysiwyg-clear-left",right:"wysiwyg-clear-right",
...
c.charset||"utf-8",stylesheets:this.config.stylesheets});h.open("text/html","replace");h.write(k);h.close();this.getWindow=function(){return f.contentWindow};this.getDocument=function(){return f.contentWindow.document};this._insertJavascripts();l.onerror=function(a,b,c){throw Error("wysihtml5.Sandbox: "+a,b,c);};if(!a.browser.supportsSandboxedIframes()){var p,k=0;for(p=b.length;k<p;k++)this._unset(l,b[k]);k=0;for(p=d.length;k<p;k++)this._unset(l,d[k],a.EMPTY_FUNCTION);k=0;for(p=e.length;k<p;k++)this._unset(h,
e[k]);this._unset(h,"cookie","",!0)}this.loaded=!0;setTimeout(function(){g.callback(g)},0)}},_getHtml:function(b){var c=b.stylesheets,d="",e=0,k;if(c="string"===typeof c?[c]:c)for(k=c.length;e<k;e++)d+='<link rel="stylesheet" href="'+c[e]+'">';b.stylesheets=d;return a.lang.string('<!DOCTYPE html><html><head><meta charset="#{charset}">#{stylesheets}</head><body></body></html>').interpolate(b)},_insertJavascripts:function(){var a=null,b=this.getDocument(),c=b.head,d=this.config.javascripts,e=0;if(d=
"string"===typeof d?[d]:d)for(length=d.length;e<length;e++)a=b.createElement("script"),a.src=d[e],c.appendChild(a)},_unset:function(b,c,d,e){try{b[c]=d}catch(k){}try{b.__defineGetter__(c,function(){return d})}catch(p){}if(e)try{b.__defineSetter__(c,function(){})}catch(m){}if(!a.browser.crashesWhenDefineProperty(c))try{var u={get:function(){return d}};e&&(u.set=function(){});Object.defineProperty(b,c,u)}catch(D){}}})})(wysihtml5);
...
!1,l):(l=h.createContextualFragment(l),h.insertNode(l));try{b(h.startContainer,h.endContainer)}catch(p){setTimeout(function(){throw p;},0)}(h=this.doc.querySelector("._wysihtml5-temp-placeholder"))?(l=rangy.createRange(this.doc),k=h.nextSibling,a.browser.hasInsertNodeIssue()&&k&&"BR"===k.nodeName?(k=this.doc.createTextNode(a.INVISIBLE_SPACE),c.insert(k).after(h),l.setStartBefore(k),l.setEndBefore(k)):(l.selectNode(h),l.deleteContents()),this.setSelection(l)):e.focus();d&&(e.scrollTop=f,e.scrollLeft=
g);try{h.parentNode.removeChild(h)}catch(m){}}else b(e,e)},executeAndRestoreSimple:function(a){var c,e,f=this.getRange(),g=this.doc.body,l;if(f){c=f.getNodes([3]);g=c[0]||f.startContainer;l=c[c.length-1]||f.endContainer;c=g===f.startContainer?f.startOffset:0;e=l===f.endContainer?f.endOffset:l.length;try{a(f.startContainer,f.endContainer)}catch(h){setTimeout(function(){throw h;},0)}a=rangy.createRange(this.doc);try{a.setStart(g,c)}catch(k){}try{a.setEnd(l,e)}catch(p){}try{this.setSelection(a)}catch(m){}}else a(g,
...
b.tagName.toLowerCase())&&d)return b;b=b.parentNode}return!1},postApply:function(a,b){for(var c=a[0],d=a[a.length-1],f=[],g,l=c,r=d,s=0,w=d.length,t,B,A=0,v=a.length;A<v;++A)t=a[A],(B=this.getAdjacentMergeableTextNode(t.parentNode,!1))?(g||(g=new e(B),f.push(g)),g.textNodes.push(t),t===c&&(l=g.firstTextNode,s=l.length),t===d&&(r=g.firstTextNode,w=g.getLength())):g=null;if(c=this.getAdjacentMergeableTextNode(d.parentNode,!0))g||(g=new e(d),f.push(g)),g.textNodes.push(c);if(f.length){A=0;for(v=f.length;A<
v;++A)f[A].doMerge();b.setStart(l,s);b.setEnd(r,w)}},getAdjacentMergeableTextNode:function(b,c){var d=b.nodeType==a.TEXT_NODE,e=d?b.parentNode:b,f=c?"nextSibling":"previousSibling";if(d){if((d=b[f])&&d.nodeType==a.TEXT_NODE)return d}else if((d=e[f])&&this.areElementsMergeable(b,d))return d[c?"firstChild":"lastChild"];return null},areElementsMergeable:function(a,b){var d;if(d=c.dom.arrayContains(this.tagNames,(a.tagName||"").toLowerCase()))if(d=c.dom.arrayContains(this.tagNames,(b.tagName||"").toLowerCase()))if(d=
...
(function(a){function c(c,g){var l=c.doc,h="_wysihtml5-temp-"+ +new Date,k=0,p,m,u;a.commands.formatInline.exec(c,b,d,h,/non-matching-class/g);p=l.querySelectorAll(d+"."+h);for(h=p.length;k<h;k++)for(u in m=p[k],m.removeAttribute("class"),g)m.setAttribute(u,g[u]);k=m;1===h&&(u=e.getTextContent(m),h=!!m.querySelector("*"),u=""===u||u===a.INVISIBLE_SPACE,!h&&u&&(e.setTextContent(m,g.text||m.href),l=l.createTextNode(" "),c.selection.setAfter(m),e.insert(l).after(m),k=l));c.selection.setAfter(k)}var b,
...
k,p,m,u){var D=h.doc,q=this.state(h,k,p,m,u),r=h.config.useLineBreaks,s=r?"DIV":"P",w;p="string"===typeof p?p.toUpperCase():p;if(q)h.selection.executeAndRestoreSimple(function(){u&&(q.className=q.className.replace(u,""));if(a.lang.string(q.className).trim()||!r&&"P"!==p)g.renameElement(q,"P"===p?"DIV":s);else{var e=q,f=e.ownerDocument,h=b(e),k=c(e);h&&!d(h)&&e.parentNode.insertBefore(f.createElement("br"),h);k&&!d(k)&&e.parentNode.insertBefore(f.createElement("br"),e);g.replaceWithChildNodes(q)}});
else{if(null===p||a.lang.array(l).contains(p))if(w=h.selection.getSelectedNode(),q=g.getParentElement(w,{nodeName:l})){h.selection.executeAndRestore(function(){p&&(q=g.renameElement(q,p));if(m){var a=q;a.className?(a.className=a.className.replace(u,""),a.className+=" "+m):a.className=m}});return}h.commands.support(k)?e(D,k,p||s,m):(q=D.createElement(p||s),m&&(q.className=m),f(h,q))}},state:function(a,b,c,d,e){c="string"===typeof c?c.toUpperCase():c;a=a.selection.getSelectedNode();return g.getParentElement(a,
{nodeName:c,className:d,classRegExp:e})}}})(wysihtml5);
(function(a){function c(c,f,g){var l=c+":"+f;if(!d[l]){var h=d,k=a.selection.HTMLApplier,p=b[c];c=p?[c.toLowerCase(),p.toLowerCase()]:[c.toLowerCase()];h[l]=new k(c,f,g,!0)}return d[l]}var b={strong:"b",em:"i",b:"strong",i:"em"},d={};a.commands.formatInline={exec:function(a,b,d,l,h){b=a.selection.getRange();if(!b)return!1;c(d,l,h).toggleRange(b);a.selection.setSelection(b)},state:function(d,f,g,l,h){f=d.doc;var k=b[g]||g;return!a.dom.hasElementWithTagName(f,g)&&!a.dom.hasElementWithTagName(f,k)||
...
d),b=""===g.innerHTML||g.innerHTML===wysihtml5.INVISIBLE_SPACE||"<br>"===g.innerHTML,a.selection.executeAndRestore(function(){e=wysihtml5.dom.convertToList(g,"ol");for(var a=0;a<e.children.length;a++)1>=e.children[a].innerText.length&&(e.children[a].innerHTML="")}),(b||1>=e.children[0].innerText.length)&&a.selection.selectNode(e.querySelector("li"),!0)):b.execCommand(c,!1,null)},state:function(a){a=a.selection.getSelectedNode();return wysihtml5.dom.getParentElement(a,{nodeName:"OL"})}};
...
d),b=""===g.innerHTML||g.innerHTML===wysihtml5.INVISIBLE_SPACE||"<br>"===g.innerHTML,a.selection.executeAndRestore(function(){e=wysihtml5.dom.convertToList(g,"ul");for(var a=0;a<e.children.length;a++)1>=e.children[a].innerText.length&&(e.children[a].innerHTML="")}),(b||1>=e.children[0].innerText.length)&&a.selection.selectNode(e.querySelector("li"),!0)):b.execCommand(c,!1,null)},state:function(a){a=a.selection.getSelectedNode();return wysihtml5.dom.getParentElement(a,{nodeName:"UL"})}};
...
b+"]")).get(),e=c.length,f=0,g=this[b+"Mapping"]={},l,h,k,p,m;f<e;f++)l=c[f],k=l.getAttribute("data-wysihtml5-"+b),p=l.getAttribute("data-wysihtml5-"+b+"-value"),h=this.container.querySelector("[data-wysihtml5-"+b+"-group='"+k+"']"),m=this._getDialog(l,k),g[k+":"+p]={link:l,group:h,name:k,value:p,dialog:m,state:!1}},_getDialog:function(b,c){var e=this,f=this.container.querySelector("[data-wysihtml5-dialog='"+c+"']"),g,l;f&&(g=new a.toolbar.Dialog(b,f),g.on("show",function(){l=e.composer.selection.getBookmark();
...
function(){this.synchronizer=new a.views.Synchronizer(this,this.textarea,this.composer);this.config.toolbar&&(this.toolbar=new a.toolbar.Toolbar(this,this.config.toolbar))})},isCompatible:function(){return this._isCompatible},clear:function(){this.currentView.clear();return this},getValue:function(a){return this.currentView.getValue(a)},setValue:function(a,c){this.fire("unset_placeholder");if(!a)return this.clear();this.currentView.setValue(a,c);return this},focus:function(a){this.currentView.focus(a);
