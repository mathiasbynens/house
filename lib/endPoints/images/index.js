                    ...
                    if (err) {
                        ...
                        var processThumbnailsFromExifAndPath = function(exifObject, fullPath, callback) {
                            ...
                            var procSizeMedium = function(fullPath, callback) {
                                if (mediumSize < origW) {
                                    var convertFullToFull = [fullPath, "-auto-orient", "-strip", "-resize", mediumSize, tmpMediumPath];
                            ...
                            var procSizeSmall = function(fullPath, callback) {
                                if (smallSize < origW) {
                                    var convertFullToFull = [fullPath, "-auto-orient", "-strip", "-resize", smallSize, tmpSmallPath];
                            ...
                            var procSizeSquare = function(fullPath, callback) {
                                ...
                                var convertFullToSquare = [fullPath, "-auto-orient", "-gravity", gravityDir, "-strip", "-extent", squareDimension + "x" + squareDimension, tmpSquarePath];
