...
(exports = module.exports = function(house, options) {
    ...
    var sendResetLinkTxtTo = function(txt, to) {
        if(!emailServer) {
                            ...
                            if(error) {
                                ...
                                var redirectTwitterUrl = function(twitterUser) {
                                    ...
                                    var getTwitterUserFriends = function(callback) {
                                        ...
                                        var oaGet = function(cursor) {
                                            ...
                                            console.log('getTwitterUserFriends oaGet cursor: '+cursor);
                                            console.log(url);
                                ...
                                showUserById(additionalParameters.user_id, function(err, twitterUser) {
                                    if(err) {
                                        ...
                                        var twitterUserUrl = twitterUser.url;

                                        getRedirectDestFromUrl(twitterUserUrl, function(twitterUserUrl) {
                ...
                if(req.fields.hasOwnProperty('email') && req.fields.hasOwnProperty('resetPass') && req.fields.resetPass) {
                    ...
                    ds.update(col, {
                        ...
                        if(err) {
                            ...
                            sendResetLinkTxtTo(txt, req.fields.email);
                        }
                    });
