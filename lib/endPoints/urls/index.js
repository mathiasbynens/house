                ...
                if(err) {
                    ...
                    if(gridfile.contentType.indexOf('image') !== -1) {
                        ...
                        var findMetaImageThumbnail = function(html, callback) {
                            console.log('findMetaImageThumbnail')
                            ...
                            if(matches && matches.length > 0) {
                                ...
                                findUrlDoc(ogImageUrl, function(err, urlDoc){
                                    if(err) {
                                        ...
                                        if(urlDoc.file) {
                                            callback(ogImageUrl, urlDoc.file);
                                        }
                                    } else {
                                        importOgImageUrl(ogImageUrl, callback);
                                    }
                                ...
                                if(imgSrcMatches && imgSrcMatches.length > 0) {
                                    ...
                                    //importOgImageUrl(linkImageUrl, callback);
                                    findUrlDoc(linkImageUrl, function(err, urlDoc){
                                        if(err) {
                                            house.log.err(err);
                                        } else if(urlDoc) {
                                            if(urlDoc.file) {
                                                callback(linkImageUrl, urlDoc.file);
                                            }
                                        } else {
                                            importOgImageUrl(linkImageUrl, callback);
                                        }
                        ...
                        var findFavicon = function(urlStr, html, callback) {
                            ...
                            if(faviMatches && faviMatches.length > 4) {
                                ...
                                var faviRegB = new RegExp(/<link.*?rel=("|\').*icon("|\').*?href=("|\')(.*?)("|\')/);
                                                ...
                                                findFavicon(urlDoc.url, html, function(gridStore){
                                                    if(gridStore) {
                                                        ...
                                                        findMetaImageThumbnail(html, function(ogImageUrl, gridStore){
                                                            if(gridStore) {
                                                                console.log('imported og:image url');
                                                                var g = {
                                                                    id: gridStore.fileId,
                                                                    filename: gridStore.filename,
                                                                    length: gridStore.position,
                                                                ...
                                                                if(gridfile.contentType.indexOf('image') !== -1) {
                                                                    ...
                                                                    filesEndPoint.call(this, {session: req.session, method: 'PUT', url: '/'+gridfile.id, fields: {"$set":{"metadata.proc":0}}}, {end:function(){}, data:function(resData){
                                                                        ...
                                                                        if(resData.hasOwnProperty('image')) {
                                                                            ...
                                                                            if(gridfile.metadata.srcUrl) {
                                                                                updateUrlDoc["$set"].ogImage.srcUrl = gridfile.metadata.srcUrl;
                                                                            }
