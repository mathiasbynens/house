                ...
                if(err) {
                    ...
                    if(gridfile.contentType.indexOf('image') !== -1) {
                        ...
                        var findFavicon = function(urlStr, html, callback) {
                            ...
                            if(faviMatches && faviMatches.length > 0) {
                                //house.log.debug('faviMatches')
                                //house.log.debug(faviMatches)
                                var str = faviMatches[1];
                                if(str.substr(0,4) == 'http') {
                                    ...
                                    faviconUrl = parsedUrl.protocol + '//' + parsedUrl.host + str;
                                }
                        ...
                        ds.find(col, query, function(err, data) {
                            ...
                            if(updateGroups) {
                                ...
                                if(updatedDoc.hasOwnProperty('groups')) {
                                    ...
                                    imagesEndPoint({session: req.session, method: 'PUT', url: '/'+updatedDoc.image.id, fields: {"$set": {groups: updatedDoc.groups}}}, {end:function(){}, data:function(newFeedData){
                                    },writeHead:function(){}});
                                }
                            }
