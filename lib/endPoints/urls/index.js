        ...
        var processUrls = function(urls, callback) {
            ...
            house.utils.media.gridfs.importUrl(ds.db, 'files', urlDoc.url, metadata, function(err, gridfile){
                ...
                if(err) {
                    ...
                    if(gridfile.contentType.indexOf('image') !== -1) {
                    ...
                    } else if(gridfile.contentType == 'application/xml') {
                        ...
                        if(gridfile.metadata.exif) {
                            ...
                            // need to get meta from non exif parse
                        }
                        parseGridFileFeed(function(err, meta, articles){
                            if(err) {
                                ...
                                if(channel.link) {
                                    // post this to urls
                                    handleReq.call(this, {session: req.session, method: 'POST', url: '', fields: {"url": channel.link, "rssUrl": urlDoc.url}}, {end:function(){}, data:function(resData){
