                    ...
                    if(gridfile.contentType.indexOf('image') !== -1) {
                        ...
                        if(gridfile.metadata.exif) {
                            ...
                            if(gridfile.metadata.exif.hasOwnProperty("Rss Channel Link")) {
                                ...
                                // post this to urls
                                handleReq.call(this, {session: req.session, method: 'POST', url: '/', fields: {"url": channel.link}}, {end:function(){}, data:function(resData){
                                    console.log('posted url of channel link');
                                    console.log(resData);
                                },writeHead:function(){}});
                        ...
                        mongo.GridStore.read(ds.db, gridfile.filename, gridfile.length, 0, {root: filesRoot}, function(err, data) {
                          if(err) {
                            ...
                            feedparser.parseString(data.toString(), parseOpts)
