...
(exports = module.exports = function(config){
    ...
    if(house.config.requireSsl) {
        ...
        house.io = require('socket.io').listen(house.httpsServer, socketOpts); // house.httpServer
        ...
        // Socket IO
        house.config.socketPort = house.config.socketPort || 843;
        house.io = require('socket.io').listen(house.httpServer, socketOpts); // house.httpServer
        house.io.sockets.on('connection', function (socket) {
