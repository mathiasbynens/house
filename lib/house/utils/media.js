(function(){
    ...
    media.gridfs.importFile = function(db, filesCol, gridFilename, filePath, mimeType, metadata, callback) {
        ...
        media.gridfs.getUniqueFilename(db, filesCol, file_name, function(unique_file_name) {
            console.log('unique filename found: '+unique_file_name);
    ...
    media.url.importFileToTmp = function(url, callback) {
        ...
        var curl = spawn("curl", ["-i", "--compressed", "--user-agent", userAgent, "-L", url ]);
        ...
        curl.on("close", function(code) {
            console.log("curl close with code: "+code);
            //console.log('curlData');
            //console.log(curlData);
            //console.log('break index '+breakIndex);
            // X-Frame-Options: SAMEORIGIN
            var breakIndex = curlData.lastIndexOf(breakStr);
            var headData = curlData.substr(0, breakIndex);
