                ...
                for(var i in data) {
                    ...
                    if(it.hasOwnProperty('itunes')) {
                        ...
                        if(itunes.hasOwnProperty('summary')) {
                            ...
                            var itunesSummaryS = S(itunesSummaryStr).collapseWhitespace().replaceAll('<br/>', '\n').replaceAll('<br />', '\n').replaceAll('<br>', '\n').stripTags();
                            itunesSummaryStr = itunesSummaryS.truncate(3990, ' ...').s;
                            
                            str = str + '<itunes:summary>'+itunesSummaryStr+'</itunes:summary>';
                        }
                    ...
                    if(it.hasOwnProperty('media')) {
                        var media = it.media;
                        if(media.metadata && media.metadata.duration) {
                            str = str + '<itunes:duration>'+media.metadata.duration+'</itunes:duration>';
                        }
