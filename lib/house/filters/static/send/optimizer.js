...
var optimizeUrl = function(url, publicFolder) {
    // console.log('optimize: '+url);
    if(isOptimizing) {
        // console.log('optimizer already working...');
        return;
    }
    isOptimizing = true;
    ...
    if(jses.length > 1) {
        ...
        // TODO watch files that were included by require that were not in the req path url
