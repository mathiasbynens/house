...
exports = module.exports = function(house, options) {
    ...
    var forkOptimizer = function() {
        house.log.debug('forking js optimizer');
        ...
        forkedOptimizer.on('close', function(){
            house.log.debug('forking js optimizer closed, restart..');
            forkOptimizer();
        });
        house.forkedOptimizer = forkedOptimizer;
    }
